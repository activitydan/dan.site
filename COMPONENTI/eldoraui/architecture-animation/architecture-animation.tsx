...
import TextShimmer from "@/registry/eldoraui/text-shimmer";
import { cn } from "@/lib/utils";
import { motion } from "motion/react";

const EldoraVariants = {
...
export default function EldoraUI({
  className,
    ...
    <div className={cn("relative text-muted", className)}>
      ...
      <svg width="100%" height="100%" viewBox="0 0 200 100">
        <defs>
          ...
          <radialGradient id="eldoraui-white-grad" fx="1">
        ...
        <g stroke="currentColor" strokeWidth="0.2" fill="none">
          <motion.rect
            variants={{
              ...EldoraVariants,
              visible: { ...EldoraVariants.visible, opacity: 1 },
            }}
            initial="hidden"
            animate="visible"
            transition={EldoraTransition}
            x="160"
            y="29.5"
            width="14"
            height="14"
          ...
          />
          <motion.rect
            variants={EldoraVariants}
            initial="hidden"
            animate="visible"
            transition={{ ...EldoraTransition, delay: 0.3 }}
            x="176"
            y="29.5"
            width="14"
            height="14"
          ...
          <motion.rect
            ...
            initial="hidden"
            animate="visible"
            transition={{ ...EldoraTransition, delay: 0.6 }}
            x="160"
            y="45.5"
            width="14"
            height="14"
          ...
          <motion.rect
            ...
            initial="hidden"
            animate="visible"
            transition={{ ...EldoraTransition, delay: 0.9 }}
            x="176"
            y="45.5"
            width="14"
            height="14"
          ...
          <motion.text
            ...
            initial="hidden"
            animate="visible"
            transition={{ ...EldoraTransition, delay: 1.5 }}
            x="175"
            y="64"
            textAnchor="middle"
            dy=".3em"
        ...
        <g mask="url(#shadn-mask1)">
          <circle
            className="eldoraui eldoraui-line-1"
            cx="0"
            cy="0"
            r="8"
            fill="url(#eldoraui-white-grad)"
          />
        </g>
        <g mask="url(#shadn-mask2)">
          <circle
            className="eldoraui eldoraui-line-2"
            cx="0"
            cy="0"
            r="8"
            fill="url(#eldoraui-white-grad)"
        ...
        <g mask="url(#shadn-mask3)">
          <circle
            className="eldoraui eldoraui-line-3"
            cx="0"
            cy="0"
            r="8"
            fill="url(#eldoraui-white-grad)"
